...
% Last Modified by GUIDE v2.5 20-Aug-2021 20:00:13
...
msgbox('\fontsize{12}You are not eligible to vote.', CreateStruct)
...
msgbox('\fontsize{12}You are not eligible to vote.', CreateStruct)
          ...
          h = msgbox(sprintf('Successfully registerd and registration no. is %d', g));
set(h, 'position', [400 320 310 55]); %makes box bigger
