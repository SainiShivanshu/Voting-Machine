...
% Last Modified by GUIDE v2.5 21-Aug-2021 23:36:49
...
if k==""
        %****************  below code to change size and font of msgbox **************
CreateStruct.Interpreter = 'tex';
CreateStruct.WindowStyle = 'modal';
msgbox('\fontsize{12}Fill the registration no. and if not registered then register first.', CreateStruct)


else if p~=m
  CreateStruct.Interpreter = 'tex';
CreateStruct.WindowStyle = 'modal';
msgbox('\fontsize{12}Invalid Registration No.', CreateStruct)


 

%****************  below code to change font of msgbox **************
